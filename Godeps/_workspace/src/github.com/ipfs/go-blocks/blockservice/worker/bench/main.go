/*
Benchmark github.com/ipfs/go-blocks/blockservice/worker.
...
per block-transfer operation for each value.  Run with:
  ...
  $ go run "${GOPATH}/src/github.com/ipfs/go-blocks/blockservice/worker/bench/main.go"
*/
...
import (
	...
	worker "github.com/ipfs/go-ipfs/Godeps/_workspace/src/github.com/ipfs/go-blocks/blockservice/worker"
	blockstore "github.com/ipfs/go-ipfs/Godeps/_workspace/src/github.com/ipfs/go-blocks/blockstore"
	"github.com/ipfs/go-ipfs/Godeps/_workspace/src/github.com/ipfs/go-blocks/thirdparty/datastore2"
	"github.com/ipfs/go-ipfs/Godeps/_workspace/src/github.com/ipfs/go-blocks/thirdparty/delay"
