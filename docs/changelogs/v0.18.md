...
- [Kubo changelog v0.18](#kubo-changelog-v018)
  - [v0.18.0](#v0180)
    ...
    - [🔦 Highlights](#-highlights)
      ...
      - [Automated default `Routing.Type`](#automated-default-routingtype)
    - [Changelog](#changelog)
...
Content routing is the process of discovering which peers provide a piece of content. Kubo has traditionally only supported the Kademlia DHT for content routing.
