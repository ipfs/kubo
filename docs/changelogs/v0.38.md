...
- [🔦 Highlights](#-highlights)
  ...
  - [Fix: Provide Filestore blocks on write](#️-provide-filestore-blocks-on-write)  
...
#### Provide Filestore blocks on write

Improvements to the providing system in the last release (provide blocks according to the configured Strategy) left out Filestore blocks when the "all" strategy was used. They would only be reprovided but not provider on write. This is now fixed, and Filestore blocks will be provided correctly.
