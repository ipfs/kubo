...
#### 🧷 Add support for named pins

You can now assign human-readable names to pinned CIDs, making it easier to reference and manage content without relying on raw multihashes.

This update introduces a new `--pin-name` flag to `ipfs add`, allowing you to associate a symbolic name with your pinned content.
