...
- github.com/ipfs/go-fs-lock (v0.0.4 -> v0.0.5):
  ...
  - Add autocomment configuration
  - Add standard issue template
- github.com/stateless-minds/go-ipfs-cmds (v0.2.2 -> v0.2.9):
  - build(deps): bump github.com/ipfs/go-log from 1.0.3 to 1.0.4 ([ipfs/go-ipfs-cmds#194](https://github.com/stateless-minds/go-ipfs-cmds/pull/194))
  - Fix go-ipfs#7242: Remove "HEAD" from Allow methods ([ipfs/go-ipfs-cmds#195](https://github.com/stateless-minds/go-ipfs-cmds/pull/195))
  - Staticcheck fixes (#196) ([ipfs/go-ipfs-cmds#196](https://github.com/stateless-minds/go-ipfs-cmds/pull/196))
  - doc: update docs for interface changes ([ipfs/go-ipfs-cmds#197](https://github.com/stateless-minds/go-ipfs-cmds/pull/197))
  - Add standard issue template
