...
- [🔦 Highlights](#-highlights)
  ...
  - [📊 Telemetry collects whether the sweep provider is enabled](#-telemtry-collects-whether-the-sweep-provider-is-enabled)  
...
`Provide.DHT.SweepProvider` flag is enabled or disabled. More information on the telemetry system in the [documentation](https://github.com/ipfs/kubo/blob/master/docs/telemetry.md).
