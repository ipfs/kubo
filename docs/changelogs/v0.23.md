...
#### Gateway: new `DeserializedResponses` option

A new option `DeserializedResponses` was added to the gateway configuration. With this
option, you can disable pretty HTML error pages. Instead, a plain text error will be
shown. This can be useful if you want to provide a gateway using Kubo, but withing a
whitelabel setup.
