...
| [telemetry](https://github.com/ipfs/kubo/tree/master/plugin/plugins/telemetry) | Telemetry | x         | Reports anonymized usage data to an endpoint the operator configures. None is built in. |
