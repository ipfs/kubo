...
_ipfs()
{
    ...
    case "${COMP_CWORD}" in
        1)
            local opts="init add cat get ls refs block object files file daemon mount resolve name dns pin repo id bootstrap swarm dht ping diag config version update commands"
            COMPREPLY=( $(compgen -W "${opts}" -- ${word}) );;
        2)
