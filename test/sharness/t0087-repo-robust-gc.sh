...
test_gc_robust_part2() {
  ...
  LEAF1=QmdNm2i5YeSuFN4SeeuJMUU4v9BRnqYGWoF8CTggY2yr62
  LEAF1FILE=.ipfs/blocks/U5/CIQN62M4YVUXIIJYGHNISR7NYPNNFWCB2VMFFR5IVPECASFAIKD3U5Y.data

  LEAF2=QmbEBRZ2tKn5PFJPeix4fjQ4PbKYHwQ5zjsN3NGUCsiB7F
  LEAF2FILE=.ipfs/blocks/G6/CIQL674X5ZST3LBHCQEI7XFQU3KCDTQ2VZ2VROXTMXZD52ZR25R6G6Q.data
