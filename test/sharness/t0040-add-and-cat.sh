...
test_add_named_pipe " Post http://$API_ADDR/api/v0/add?chunker=size-262144&encoding=json&hash=sha2-256&hidden=true&inline-limit=32&pin=true&progress=true&recursive=true&stream-channels=true:"
