...
func testBootstrapAddAutoExplicitly(t *testing.T) {
...
func testBootstrapRemoveWithAuto(t *testing.T) {
...
func testBootstrapRemoveAllWithAuto(t *testing.T) {
...
func testBootstrapMixedAutoAndSpecificPeers(t *testing.T) {
