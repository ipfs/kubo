...
import (
	...
	yamux "gx/ipfs/QmToVv5dR2ubCWZXgQeetnTkG8hEWz1Mnm5FAQ2qtBuZDH/yamux" // stream implements smux.Stream using a ss.Stream
)
...
var DefaultTransport = (*Transport)(&yamux.Config{
	...
	ConnectionWriteTimeout: time.Second * 10,   // from yamux.DefaultConfig
