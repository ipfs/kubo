...
var defaultLimits = rcmgr.DefaultLimitConfig{
...
// This is a vendored copy of
// https://github.com/libp2p/go-libp2p-resource-manager/blob/v0.1.5/limit_static.go#L78
func newDefaultLimiter() *rcmgr.BasicLimiter {
	return rcmgr.NewStaticLimiter(defaultLimits)
}
