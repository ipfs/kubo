...
func (api *SwarmAPI) Connect(ctx context.Context, addr coreiface.Addr) error {
...
func (api *SwarmAPI) Disconnect(ctx context.Context, addr coreiface.Addr) error {
	if api.node.PeerHost == nil {
		return coreiface.ErrOffline
	}
...
func (ci *connInfo) ID() coreiface.PeerID {
	return ci.ID()
}

func (ci *connInfo) Address() coreiface.Addr {
	return ci.addr
}
