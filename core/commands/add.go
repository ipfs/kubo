...
`,
	...
	Options: []cmds.Option{
		...
		cmds.Int64Option(maxLinksOptionName, "Limit the maximum number of links in UnixFS file and basic directory nodes to this value."),
		cmds.Int64Option(maxHAMTFanoutOptionName, "Limit the maximum number of links of a UnixFS HAMT directory node to this (power of 2, multiple of 8)."),
