...
`,
	...
	Options: []cmds.Option{
		...
		cmds.IntOption(inlineLimitOptionName, fmt.Sprintf("Maximum block size to inline. Maximum: %d bytes. WARNING: experimental. Default: 32", verifcid.DefaultMaxIdentityDigestSize)).WithDefault(32),
