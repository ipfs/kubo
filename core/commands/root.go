...
`,
	...
	Options: []cmds.Option{
		cmds.StringOption("config", "c", "Path to the configuration file to use.").Default("~/.ipfs/config"),
		...
		cmds.StringOption(ApiOption, "Use a specific API instance.").Default("/ip4/127.0.0.1/tcp/5001"),
	},
}
