...
func New(parent context.Context, network bsnet.BitSwapNetwork,
	bstore blockstore.Blockstore, rrqCfg *decision.RRQConfig) exchange.Interface {
	...
	bs := &Bitswap{
		blockstore:    bstore,
		notifications: notif,
		engine:        decision.NewEngine(ctx, bstore, rrqCfg), // TODO close the engine with Close() method
		network:       network,
